...
function TerritoriesPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {remoteDropCount > 0 && (
        <div className="rounded border border-[#ff2d55]/60 bg-[#ff2d55]/10 px-3 py-2 font-display text-[10px] uppercase tracking-widest text-[#ff8fa3] flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between">
