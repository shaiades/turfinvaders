...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://turf-invaders.vercel.app/turf-invaders-hero.png" },
      { name: "twitter:image", content: "https://turf-invaders.vercel.app/turf-invaders-hero.png" },
